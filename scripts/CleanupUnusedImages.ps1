...
$images = Get-ChildItem -Path "./tutorials/images" -Recurse | Where-Object { -not $_.PSIsContainer }
...
foreach($file in $images)
{
    ...
    $references = Get-ChildItem -Path "./tutorials/*.md" -Recurse | Select-String $file.Name
